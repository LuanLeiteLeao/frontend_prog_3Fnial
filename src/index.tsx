...
import { DeletarGenero } from "./page/genero/deletar/DeletarGeneros";
...
import { EditarGame } from "./page/game/editar/EditarGame";
import { EditarGenero } from "./page/genero/editar/EditarGenero";
...
ReactDOM.render(
  <BrowserRouter>
    <Switch>
      ...
      <Route path="/game/editar/:id" component={EditarGame} />
      {/* generos rotas */}
      ...
      <Route path="/genero/editar/:id" component={EditarGenero} />
      {/* plataformas Rotas */}
